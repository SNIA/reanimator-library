/*
 * This file was auto generated on Wed Dec 23 12:58:49 2020.
 * DO NOT EDIT BY HAND.
 */
#ifdef USE_ENUMS
enum syscall_names {
...
enum syscall_fields {
	...
	SYSCALL_FIELD_ADDRESS = 1,
	SYSCALL_FIELD_ALLOCATE_LEN = 2,
	SYSCALL_FIELD_ALLOCATE_OFFSET = 3,
	SYSCALL_FIELD_ARGUMENT = 4,
	SYSCALL_FIELD_ARGUMENT_DESCRIPTOR_FLAG_EXEC_CLOSE = 5,
	SYSCALL_FIELD_ARGUMENT_LEASE_READ = 6,
	SYSCALL_FIELD_ARGUMENT_LEASE_REMOVE = 7,
	SYSCALL_FIELD_ARGUMENT_LEASE_WRITE = 8,
	SYSCALL_FIELD_ARGUMENT_NOTIFY_ACCESS = 9,
	SYSCALL_FIELD_ARGUMENT_NOTIFY_ATTRIBUTE = 10,
	SYSCALL_FIELD_ARGUMENT_NOTIFY_CREATE = 11,
	SYSCALL_FIELD_ARGUMENT_NOTIFY_DELETE = 12,
	SYSCALL_FIELD_ARGUMENT_NOTIFY_MODIFY = 13,
	SYSCALL_FIELD_ARGUMENT_NOTIFY_RENAME = 14,
	SYSCALL_FIELD_ARGUMENT_STATUS_FLAG_APPEND = 15,
	SYSCALL_FIELD_ARGUMENT_STATUS_FLAG_ASYNC = 16,
	SYSCALL_FIELD_ARGUMENT_STATUS_FLAG_CREATE = 17,
	SYSCALL_FIELD_ARGUMENT_STATUS_FLAG_DIRECT = 18,
	SYSCALL_FIELD_ARGUMENT_STATUS_FLAG_DIRECTORY = 19,
	SYSCALL_FIELD_ARGUMENT_STATUS_FLAG_EXCLUSIVE = 20,
	SYSCALL_FIELD_ARGUMENT_STATUS_FLAG_LARGEFILE = 21,
	SYSCALL_FIELD_ARGUMENT_STATUS_FLAG_NO_ACCESS_TIME = 22,
	SYSCALL_FIELD_ARGUMENT_STATUS_FLAG_NO_BLOCKING_MODE = 23,
	SYSCALL_FIELD_ARGUMENT_STATUS_FLAG_NO_CONTROLLING_TERMINAL = 24,
	SYSCALL_FIELD_ARGUMENT_STATUS_FLAG_NO_DELAY = 25,
	SYSCALL_FIELD_ARGUMENT_STATUS_FLAG_NO_FOLLOW = 26,
	SYSCALL_FIELD_ARGUMENT_STATUS_FLAG_READ_AND_WRITE = 27,
	SYSCALL_FIELD_ARGUMENT_STATUS_FLAG_READ_ONLY = 28,
	SYSCALL_FIELD_ARGUMENT_STATUS_FLAG_SYNCHRONOUS = 29,
	SYSCALL_FIELD_ARGUMENT_STATUS_FLAG_TRUNCATE = 30,
	SYSCALL_FIELD_ARGUMENT_STATUS_FLAG_WRITE_ONLY = 31,
	SYSCALL_FIELD_ARGUMENT_VALUE = 32,
	SYSCALL_FIELD_BACKLOG = 33,
	SYSCALL_FIELD_BUFFER_NOT_CAPTURED = 34,
	SYSCALL_FIELD_BUFFER_SIZE = 35,
	SYSCALL_FIELD_BYTES_REQUESTED = 36,
	SYSCALL_FIELD_CHILD_STACK_ADDRESS = 37,
	SYSCALL_FIELD_CHILD_THREAD_ID = 38,
	SYSCALL_FIELD_COMMAND_DUP = 39,
	SYSCALL_FIELD_COMMAND_GET_DESCRIPTOR_FLAGS = 40,
	SYSCALL_FIELD_COMMAND_GET_LEASE = 41,
	SYSCALL_FIELD_COMMAND_GET_LOCK = 42,
	SYSCALL_FIELD_COMMAND_GET_PROCESS_ID = 43,
	SYSCALL_FIELD_COMMAND_GET_SIGNAL = 44,
	SYSCALL_FIELD_COMMAND_GET_STATUS_FLAGS = 45,
	SYSCALL_FIELD_COMMAND_NOTIFY = 46,
	SYSCALL_FIELD_COMMAND_SET_DESCRIPTOR_FLAGS = 47,
	SYSCALL_FIELD_COMMAND_SET_LEASE = 48,
	SYSCALL_FIELD_COMMAND_SET_LOCK = 49,
	SYSCALL_FIELD_COMMAND_SET_LOCK_WAIT = 50,
	SYSCALL_FIELD_COMMAND_SET_PROCESS_ID = 51,
	SYSCALL_FIELD_COMMAND_SET_SIGNAL = 52,
	SYSCALL_FIELD_COMMAND_SET_STATUS_FLAGS = 53,
	SYSCALL_FIELD_COMMAND_VALUE = 54,
	SYSCALL_FIELD_CONTINUATION_NUMBER = 55,
	SYSCALL_FIELD_COUNT = 56,
	SYSCALL_FIELD_DATA_READ = 57,
	SYSCALL_FIELD_DATA_WRITTEN = 58,
	SYSCALL_FIELD_DESCRIPTOR = 59,
	SYSCALL_FIELD_DESCRIPTOR_CURRENT_WORKING_DIRECTORY = 60,
	SYSCALL_FIELD_DEV = 61,
	SYSCALL_FIELD_DIRENT_BUFFER = 62,
	SYSCALL_FIELD_DOMAIN = 63,
	SYSCALL_FIELD_ENVIRONMENT = 64,
	SYSCALL_FIELD_EPOLL_FLAGS = 65,
	SYSCALL_FIELD_EPOLL_SIZE = 66,
	SYSCALL_FIELD_ERRNO_NUMBER = 67,
	SYSCALL_FIELD_ERRNO_STRING = 68,
	SYSCALL_FIELD_EXECUTING_PGID = 69,
	SYSCALL_FIELD_EXECUTING_PID = 70,
	SYSCALL_FIELD_EXECUTING_PPID = 71,
	SYSCALL_FIELD_EXECUTING_SID = 72,
	SYSCALL_FIELD_EXECUTING_TID = 73,
	SYSCALL_FIELD_EXECUTING_UID = 74,
	SYSCALL_FIELD_EXIT_STATUS = 75,
	SYSCALL_FIELD_FLAG_32BIT = 76,
	SYSCALL_FIELD_FLAG_ANONYMOUS = 77,
	SYSCALL_FIELD_FLAG_APPEND = 78,
	SYSCALL_FIELD_FLAG_ASYNC = 79,
	SYSCALL_FIELD_FLAG_AT_SYMLINK_NOFOLLOW = 80,
	SYSCALL_FIELD_FLAG_CHILD_CLEARTID = 81,
	SYSCALL_FIELD_FLAG_CHILD_SETTID = 82,
	SYSCALL_FIELD_FLAG_CLOSE_ON_EXEC = 83,
	SYSCALL_FIELD_FLAG_CMSG_CLOEXEC = 84,
	SYSCALL_FIELD_FLAG_CONFIRM = 85,
	SYSCALL_FIELD_FLAG_CREATE = 86,
	SYSCALL_FIELD_FLAG_DENYWRITE = 87,
	SYSCALL_FIELD_FLAG_DIRECT = 88,
	SYSCALL_FIELD_FLAG_DIRECTORY = 89,
	SYSCALL_FIELD_FLAG_DONTROUTE = 90,
	SYSCALL_FIELD_FLAG_DONTWAIT = 91,
	SYSCALL_FIELD_FLAG_DONWAIT = 92,
	SYSCALL_FIELD_FLAG_EMPTY_PATH = 93,
	SYSCALL_FIELD_FLAG_EOR = 94,
	SYSCALL_FIELD_FLAG_ERRQUEUE = 95,
	SYSCALL_FIELD_FLAG_EXCLUSIVE = 96,
	SYSCALL_FIELD_FLAG_EXECUTABLE = 97,
	SYSCALL_FIELD_FLAG_FILE = 98,
	SYSCALL_FIELD_FLAG_FILES = 99,
	SYSCALL_FIELD_FLAG_FILESYSTEM = 100,
	SYSCALL_FIELD_FLAG_FIXED = 101,
	SYSCALL_FIELD_FLAG_GROWS_DOWN = 102,
	SYSCALL_FIELD_FLAG_HUGE_TLB = 103,
	SYSCALL_FIELD_FLAG_IO = 104,
	SYSCALL_FIELD_FLAG_LARGEFILE = 105,
	SYSCALL_FIELD_FLAG_LOCKED = 106,
	SYSCALL_FIELD_FLAG_MORE = 107,
	SYSCALL_FIELD_FLAG_NEWIPC = 108,
	SYSCALL_FIELD_FLAG_NEWNET = 109,
	SYSCALL_FIELD_FLAG_NEWNS = 110,
	SYSCALL_FIELD_FLAG_NEWPID = 111,
	SYSCALL_FIELD_FLAG_NEWUSER = 112,
	SYSCALL_FIELD_FLAG_NEWUTS = 113,
	SYSCALL_FIELD_FLAG_NO_ACCESS_TIME = 114,
	SYSCALL_FIELD_FLAG_NO_BLOCKING_MODE = 115,
	SYSCALL_FIELD_FLAG_NO_CONTROLLING_TERMINAL = 116,
	SYSCALL_FIELD_FLAG_NO_DELAY = 117,
	SYSCALL_FIELD_FLAG_NO_FOLLOW = 118,
	SYSCALL_FIELD_FLAG_NO_RESERVE = 119,
	SYSCALL_FIELD_FLAG_NON_BLOCK = 120,
	SYSCALL_FIELD_FLAG_NOSIGNAL = 121,
	SYSCALL_FIELD_FLAG_OOB = 122,
	SYSCALL_FIELD_FLAG_PARENT = 123,
	SYSCALL_FIELD_FLAG_PARENT_SETTID = 124,
	SYSCALL_FIELD_FLAG_PEEK = 125,
	SYSCALL_FIELD_FLAG_POPULATE = 126,
	SYSCALL_FIELD_FLAG_PRIVATE = 127,
	SYSCALL_FIELD_FLAG_PTRACE = 128,
	SYSCALL_FIELD_FLAG_READ_AND_WRITE = 129,
	SYSCALL_FIELD_FLAG_READ_ONLY = 130,
	SYSCALL_FIELD_FLAG_REMOVE_DIRECTORY = 131,
	SYSCALL_FIELD_FLAG_SETTLS = 132,
	SYSCALL_FIELD_FLAG_SHARED = 133,
	SYSCALL_FIELD_FLAG_SIGHAND = 134,
	SYSCALL_FIELD_FLAG_STACK = 135,
	SYSCALL_FIELD_FLAG_SYMLINK_FOLLOW = 136,
	SYSCALL_FIELD_FLAG_SYMLINK_NOFOLLOW = 137,
	SYSCALL_FIELD_FLAG_SYNCHRONOUS = 138,
	SYSCALL_FIELD_FLAG_SYSVSEM = 139,
	SYSCALL_FIELD_FLAG_THREAD = 140,
	SYSCALL_FIELD_FLAG_TRUNC = 141,
	SYSCALL_FIELD_FLAG_TRUNCATE = 142,
	SYSCALL_FIELD_FLAG_UNTRACED = 143,
	SYSCALL_FIELD_FLAG_VALUE = 144,
	SYSCALL_FIELD_FLAG_VFORK = 145,
	SYSCALL_FIELD_FLAG_VM = 146,
	SYSCALL_FIELD_FLAG_WAITALL = 147,
	SYSCALL_FIELD_FLAG_WRITE_ONLY = 148,
	SYSCALL_FIELD_FLAG_XATTR_CREATE = 149,
	SYSCALL_FIELD_FLAG_XATTR_REPLACE = 150,
	SYSCALL_FIELD_FLAGS = 151,
	SYSCALL_FIELD_FLAGS_AT_EACCESS = 152,
	SYSCALL_FIELD_FLAGS_AT_EMPTY_PATH = 153,
	SYSCALL_FIELD_FLAGS_AT_NO_AUTOMOUNT = 154,
	SYSCALL_FIELD_FLAGS_AT_SYMLINK_NOFOLLOW = 155,
	SYSCALL_FIELD_FLAGS_VALUE = 156,
	SYSCALL_FIELD_FULL_NEWNAME = 157,
	SYSCALL_FIELD_FULL_NEWPATHNAME = 158,
	SYSCALL_FIELD_FULL_OLDNAME = 159,
	SYSCALL_FIELD_FULL_OLDPATHNAME = 160,
	SYSCALL_FIELD_FULL_PATHNAME = 161,
	SYSCALL_FIELD_GENERATED = 162,
	SYSCALL_FIELD_GIVEN_NEWNAME = 163,
	SYSCALL_FIELD_GIVEN_NEWPATHNAME = 164,
	SYSCALL_FIELD_GIVEN_OLDNAME = 165,
	SYSCALL_FIELD_GIVEN_OLDPATHNAME = 166,
	SYSCALL_FIELD_GIVEN_PATHNAME = 167,
	SYSCALL_FIELD_HOW = 168,
	SYSCALL_FIELD_IOCTL_BUFFER = 169,
	SYSCALL_FIELD_IOV_DATA_READ = 170,
	SYSCALL_FIELD_IOV_DATA_WRITTEN = 171,
	SYSCALL_FIELD_IOV_NUMBER = 172,
	SYSCALL_FIELD_LENGTH = 173,
	SYSCALL_FIELD_LEVEL = 174,
	SYSCALL_FIELD_LINK_VALUE = 175,
	SYSCALL_FIELD_LIST_SIZE = 176,
	SYSCALL_FIELD_LOCK_LENGTH = 177,
	SYSCALL_FIELD_LOCK_PID = 178,
	SYSCALL_FIELD_LOCK_START = 179,
	SYSCALL_FIELD_LOCK_TYPE = 180,
	SYSCALL_FIELD_LOCK_TYPE_READ = 181,
	SYSCALL_FIELD_LOCK_TYPE_UNLOCKED = 182,
	SYSCALL_FIELD_LOCK_TYPE_WRITE = 183,
	SYSCALL_FIELD_LOCK_WHENCE = 184,
	SYSCALL_FIELD_LOCK_WHENCE_CURRENT = 185,
	SYSCALL_FIELD_LOCK_WHENCE_END = 186,
	SYSCALL_FIELD_LOCK_WHENCE_START = 187,
	SYSCALL_FIELD_MOD_TIME = 188,
	SYSCALL_FIELD_MODE_R_GROUP = 189,
	SYSCALL_FIELD_MODE_R_OTHERS = 190,
	SYSCALL_FIELD_MODE_R_USER = 191,
	SYSCALL_FIELD_MODE_W_GROUP = 192,
	SYSCALL_FIELD_MODE_W_OTHERS = 193,
	SYSCALL_FIELD_MODE_W_USER = 194,
	SYSCALL_FIELD_MODE_X_GROUP = 195,
	SYSCALL_FIELD_MODE_X_OTHERS = 196,
	SYSCALL_FIELD_MODE_X_USER = 197,
	SYSCALL_FIELD_MODE_EXECUTE = 198,
	SYSCALL_FIELD_MODE_EXIST = 199,
	SYSCALL_FIELD_MODE_GID = 200,
	SYSCALL_FIELD_MODE_READ = 201,
	SYSCALL_FIELD_MODE_STICKY_BIT = 202,
	SYSCALL_FIELD_MODE_UID = 203,
	SYSCALL_FIELD_MODE_VALUE = 204,
	SYSCALL_FIELD_MODE_WRITE = 205,
	SYSCALL_FIELD_NEW_DESCRIPTOR = 206,
	SYSCALL_FIELD_NEW_DESCRIPTOR_CURRENT_WORKING_DIRECTORY = 207,
	SYSCALL_FIELD_NEW_GROUP = 208,
	SYSCALL_FIELD_NEW_OWNER = 209,
	SYSCALL_FIELD_NEW_TLS = 210,
	SYSCALL_FIELD_OFFSET = 211,
	SYSCALL_FIELD_OLD_DESCRIPTOR = 212,
	SYSCALL_FIELD_OLD_DESCRIPTOR_CURRENT_WORKING_DIRECTORY = 213,
	SYSCALL_FIELD_OPEN_VALUE = 214,
	SYSCALL_FIELD_OPERATION = 215,
	SYSCALL_FIELD_OPERATION_VALUE = 216,
	SYSCALL_FIELD_OPTION_VALUE = 217,
	SYSCALL_FIELD_OPTNAME = 218,
	SYSCALL_FIELD_PARAMETER = 219,
	SYSCALL_FIELD_PARENT_THREAD_ID = 220,
	SYSCALL_FIELD_PGID = 221,
	SYSCALL_FIELD_PID = 222,
	SYSCALL_FIELD_PROTECTION_EXEC = 223,
	SYSCALL_FIELD_PROTECTION_NONE = 224,
	SYSCALL_FIELD_PROTECTION_READ = 225,
	SYSCALL_FIELD_PROTECTION_VALUE = 226,
	SYSCALL_FIELD_PROTECTION_WRITE = 227,
	SYSCALL_FIELD_PROTOCOL = 228,
	SYSCALL_FIELD_READ_DESCRIPTOR = 229,
	SYSCALL_FIELD_READAHEAD_OFF = 230,
	SYSCALL_FIELD_READAHEAD_SIZE = 231,
	SYSCALL_FIELD_REQUEST = 232,
	SYSCALL_FIELD_RESOURCE = 233,
	SYSCALL_FIELD_RESOURCE_HARD_LIMIT = 234,
	SYSCALL_FIELD_RESOURCE_SOFT_LIMIT = 235,
	SYSCALL_FIELD_RESOURCE_VALUE = 236,
	SYSCALL_FIELD_RETURN_VALUE = 237,
	SYSCALL_FIELD_SIGNAL_ABORT = 238,
	SYSCALL_FIELD_SIGNAL_ALARM = 239,
	SYSCALL_FIELD_SIGNAL_BUS = 240,
	SYSCALL_FIELD_SIGNAL_CHILD = 241,
	SYSCALL_FIELD_SIGNAL_CONTINUE = 242,
	SYSCALL_FIELD_SIGNAL_CPU_EXCEEDED = 243,
	SYSCALL_FIELD_SIGNAL_FILE_SIZE_EXCEEDED = 244,
	SYSCALL_FIELD_SIGNAL_FLOATING_POINT_EXCEPTION = 245,
	SYSCALL_FIELD_SIGNAL_HANGUP = 246,
	SYSCALL_FIELD_SIGNAL_ILLEGAL = 247,
	SYSCALL_FIELD_SIGNAL_IO = 248,
	SYSCALL_FIELD_SIGNAL_IOT_TRAP = 249,
	SYSCALL_FIELD_SIGNAL_KILL = 250,
	SYSCALL_FIELD_SIGNAL_PIPE = 251,
	SYSCALL_FIELD_SIGNAL_POWER = 252,
	SYSCALL_FIELD_SIGNAL_PROF_ALARM = 253,
	SYSCALL_FIELD_SIGNAL_SEGV = 254,
	SYSCALL_FIELD_SIGNAL_STACK_FAULT = 255,
	SYSCALL_FIELD_SIGNAL_STOP = 256,
	SYSCALL_FIELD_SIGNAL_TERMINAL_INTERRUPT = 257,
	SYSCALL_FIELD_SIGNAL_TERMINAL_QUIT = 258,
	SYSCALL_FIELD_SIGNAL_TERMINAL_STOP = 259,
	SYSCALL_FIELD_SIGNAL_TERMINATION = 260,
	SYSCALL_FIELD_SIGNAL_TRACE_TRAP = 261,
	SYSCALL_FIELD_SIGNAL_TTY_READ = 262,
	SYSCALL_FIELD_SIGNAL_TTY_WRITE = 263,
	SYSCALL_FIELD_SIGNAL_URGENT = 264,
	SYSCALL_FIELD_SIGNAL_USER_DEFINED_1 = 265,
	SYSCALL_FIELD_SIGNAL_USER_DEFINED_2 = 266,
	SYSCALL_FIELD_SIGNAL_VIRTUAL_ALARM = 267,
	SYSCALL_FIELD_SIGNAL_WINDOW_SIZE_CHANGE = 268,
	SYSCALL_FIELD_SOCKADDR_BUFFER = 269,
	SYSCALL_FIELD_SOCKADDR_LENGTH = 270,
	SYSCALL_FIELD_START_ADDRESS = 271,
	SYSCALL_FIELD_STAT_RESULT_ATIME = 272,
	SYSCALL_FIELD_STAT_RESULT_BLKSIZE = 273,
	SYSCALL_FIELD_STAT_RESULT_BLOCKS = 274,
	SYSCALL_FIELD_STAT_RESULT_CTIME = 275,
	SYSCALL_FIELD_STAT_RESULT_DEV = 276,
	SYSCALL_FIELD_STAT_RESULT_GID = 277,
	SYSCALL_FIELD_STAT_RESULT_INO = 278,
	SYSCALL_FIELD_STAT_RESULT_MODE = 279,
	SYSCALL_FIELD_STAT_RESULT_MTIME = 280,
	SYSCALL_FIELD_STAT_RESULT_NLINK = 281,
	SYSCALL_FIELD_STAT_RESULT_RAW = 282,
	SYSCALL_FIELD_STAT_RESULT_RDEV = 283,
	SYSCALL_FIELD_STAT_RESULT_SIZE = 284,
	SYSCALL_FIELD_STAT_RESULT_UID = 285,
	SYSCALL_FIELD_STATFS_RESULT_BAVAIL = 286,
	SYSCALL_FIELD_STATFS_RESULT_BFREE = 287,
	SYSCALL_FIELD_STATFS_RESULT_BLOCKS = 288,
	SYSCALL_FIELD_STATFS_RESULT_BSIZE = 289,
	SYSCALL_FIELD_STATFS_RESULT_FFREE = 290,
	SYSCALL_FIELD_STATFS_RESULT_FILES = 291,
	SYSCALL_FIELD_STATFS_RESULT_FLAGS = 292,
	SYSCALL_FIELD_STATFS_RESULT_FLAGS_MANDATORY_LOCK = 293,
	SYSCALL_FIELD_STATFS_RESULT_FLAGS_NO_ACCESS_TIME = 294,
	SYSCALL_FIELD_STATFS_RESULT_FLAGS_NO_DEV = 295,
	SYSCALL_FIELD_STATFS_RESULT_FLAGS_NO_DIRECTORY_ACCESS_TIME = 296,
	SYSCALL_FIELD_STATFS_RESULT_FLAGS_NO_EXEC = 297,
	SYSCALL_FIELD_STATFS_RESULT_FLAGS_NO_SET_UID = 298,
	SYSCALL_FIELD_STATFS_RESULT_FLAGS_READ_ONLY = 299,
	SYSCALL_FIELD_STATFS_RESULT_FLAGS_RELATIVE_ACCESS_TIME = 300,
	SYSCALL_FIELD_STATFS_RESULT_FLAGS_SYNCHRONOUS = 301,
	SYSCALL_FIELD_STATFS_RESULT_FLAGS_VALID = 302,
	SYSCALL_FIELD_STATFS_RESULT_FRSIZE = 303,
	SYSCALL_FIELD_STATFS_RESULT_FSID = 304,
	SYSCALL_FIELD_STATFS_RESULT_NAMELEN = 305,
	SYSCALL_FIELD_STATFS_RESULT_RAW = 306,
	SYSCALL_FIELD_STATFS_RESULT_TYPE = 307,
	SYSCALL_FIELD_TARGET_PATHNAME = 308,
	SYSCALL_FIELD_TIME_CALLED = 309,
	SYSCALL_FIELD_TIME_RECORDED = 310,
	SYSCALL_FIELD_TIME_RETURNED = 311,
	SYSCALL_FIELD_TRUNCATE_LENGTH = 312,
	SYSCALL_FIELD_TYPE = 313,
	SYSCALL_FIELD_UNIQUE_ID = 314,
	SYSCALL_FIELD_UTIME_NOW = 315,
	SYSCALL_FIELD_UTIME_OMIT = 316,
	SYSCALL_FIELD_VALUE_READ = 317,
	SYSCALL_FIELD_VALUE_SIZE = 318,
	SYSCALL_FIELD_VALUE_WRITTEN = 319,
	SYSCALL_FIELD_WHENCE = 320,
	SYSCALL_FIELD_WHENCE_VALUE = 321,
	SYSCALL_FIELD_WRITE_DESCRIPTOR = 322,
	SYSCALL_FIELD_XATTR_LIST = 323,
	SYSCALL_FIELD_XATTR_NAME = 324,
	MAX_SYSCALL_FIELDS = 325
};
#else /* USE_ENUMS */
...
#define SYSCALL_FIELD_ADDRESS "address"
